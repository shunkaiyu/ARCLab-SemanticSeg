...
dataset="cholec"
data_dir="../src/data/datasets/fold2_13_2"
...
save_samples="True"
	...
	save_dir="../results/${model}/${dataset}_fold2_13_2/368640_random_crop/dice_factor_${dice_loss_factor}_focal_factor_${focal_loss_factor}/bs_train${train_batch_size}_val${val_batch_size}/imsize_${resized_height}x${resized_width}_wd_${wd}_optim_${optimizer}_lr${lr}_steps_${lr_steps}_gamma_${step_gamma}/e${epochs}_seed6210"
	seg_save_dir="${save_dir}/train_seg_results"
