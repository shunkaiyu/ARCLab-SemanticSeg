...
dataset="cholec"
save_test=True
checkpoint_dir="/home/arcseg/Desktop/Shunkai-working/results/smp_DeepLabV3+/cholec_fold2_13_2/368640_random_crop/dice_factor_0.0_focal_factor_0.0/bs_train12_val4/imsize_480x848_wd_0.00001_optim_Adam_lr1e-3_steps_4_gamma_0.1/e50_seed6210"
...
python ../src/evalSegNet.py \
    ...
    --saveTest $save_test \
    --model $checkpoint \
    --data_path "/home/arcseg/Desktop/Shunkai-working/src/data/datasets/fold2_13_2" \
