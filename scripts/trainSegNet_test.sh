...
train_batch_size=4 # [1, 11, 37]
val_batch_size=2 # [1, 3, 29]
...
dataset="cholec"
data_dir="../src/data/datasets/cholec_test3"
...
use_low_level="True" 
use_high_level="True" 
		save_dir="../results/${model}_hl_${use_high_level}_ll_${use_low_level}/${dataset}_test/${resized_height}x${resized_width}_test/dice_factor_${dice_loss_factor}_focal_factor_${focal_loss_factor}/bs_train${train_batch_size}_val${val_batch_size}/imsize_${resized_height}x${resized_width}_wd_${wd}_optim_${optimizer}_lr${lr}_steps_${lr_steps}_gamma_${step_gamma}/e${epochs}_seed6210"
...
use_low_level2="True" 
use_high_level2="False" 
		save_dir="../results/${model}_hl${use_high_level2}_ll${use_low_level2}/${dataset}_test/${resized_height}x${resized_width}_test/dice_factor_${dice_loss_factor}_focal_factor_${focal_loss_factor}/bs_train${train_batch_size}_val${val_batch_size}/imsize_${resized_height}x${resized_width}_wd_${wd}_optim_${optimizer}_lr${lr}_steps_${lr_steps}_gamma_${step_gamma}/e${epochs}_seed6210"
		seg_save_dir="${save_dir}/seg_results"
		...
		python ../src/trainSegNet2T.py \
			...
			--save_dir $save_dir \
			--seg_save_dir $seg_save_dir \
			--use_high_level $use_high_level2 \
			--use_low_level $use_low_level2 \
			|& tee -a "${save_dir}/debug.log"

use_low_level3="False" 
use_high_level3="True" 
		save_dir="../results/${model}_hl${use_high_level3}_ll${use_low_level3}/${dataset}_test/${resized_height}x${resized_width}_test/dice_factor_${dice_loss_factor}_focal_factor_${focal_loss_factor}/bs_train${train_batch_size}_val${val_batch_size}/imsize_${resized_height}x${resized_width}_wd_${wd}_optim_${optimizer}_lr${lr}_steps_${lr_steps}_gamma_${step_gamma}/e${epochs}_seed6210"
		seg_save_dir="${save_dir}/seg_results"
		...
		python ../src/trainSegNet2T.py \
			...
			--save_dir $save_dir \
			--seg_save_dir $seg_save_dir \
			--use_high_level $use_high_level3 \
			--use_low_level $use_low_level3 \
			|& tee -a "${save_dir}/debug.log"
