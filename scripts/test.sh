...
resized_height=128 # for random crop
resized_width=128 # for random crop
cropSize=128
...
save_samples="True"
	...
	save_dir="../results/${model}/${dataset}_test/256x256_noCrop/dice_factor_${dice_loss_factor}/bs_train${train_batch_size}_val${val_batch_size}/imsize_${resized_height}x${resized_width}_wd_${wd}_optim_${optimizer}_lr${lr}_steps_${lr_steps}_gamma_${step_gamma}/e${epochs}_seed6210"
