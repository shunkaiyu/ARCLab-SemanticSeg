...
from Segmenter import config
from Segmenter import factory
...
def main():
    ...
    if args.model == 'segnet':
        ...
        # model config
        model_cfg["image_size"] = (256, 256)
        model_cfg["backbone"] = "vit_tiny_patch16_384"
        model_cfg["dropout"] = 0.1
        model_cfg["drop_path_rate"] = 0.0
        #decoder_cfg["name"] = "mask_transformer"
        model_cfg["decoder"] = {    "drop_path_rate": 0.0,
                                        "dropout": 0.1,
                                        "n_cls": 13,
                                        "n_layers": 2,
