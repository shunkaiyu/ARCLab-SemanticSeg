...
from deeplabv3T_feelvos.base import DSH
from deeplabv3T_feelvos.base.Embeddings import PixelwiseEmbedding
...
class DeepLabV3Plus(SegmentationModel):
    ...
    def __init__(
        ...
        self.dsh = DSH.DynamicSegmentationHead(13+1+1+1, 1)
        self.embedding = PixelwiseEmbedding(13, 13, 100)
        ...
        self.testConvAfterDecoder = nn.Sequential(
                nn.Conv2d(256+13, 256, kernel_size=1, stride = 1, bias=False),
                # nn.BatchNorm2d(256),
                # nn.ReLU(),
